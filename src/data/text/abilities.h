...
static const u8 sUnburdenDescription[] = _("Raises SPEED if item is lost.");
...
static const u8 sHoneyGatherDescription[] = _("No effect without HONEY.");
...
static const u8 sCursedBodyDescription[] = _("May disable a move used on it.");
