...
const u8 gText_PlayerUsedVar2NoPause[] = _("{PLAYER} used the\n{STR_VAR_2}.");
...
const u8 gText_ChoosePokemonForSpecies[] = _("Choose POKéMON for {STR_VAR_2}.");
...
const u8 gText_CannotSendActiveMonToBox[] = _("An active POKéMON can't be sent\nto the PC.{PAUSE_UNTIL_PRESS}");
const u8 gText_CannotSendSurfMonToBox[] = _("The POKéMON you're SURFING on\ncan't be sent to the PC.{PAUSE_UNTIL_PRESS}");
const u8 gText_CannotSendMailMonToBox[] = _("A POKéMON holding MAIL can't be\nsent to the PC.{PAUSE_UNTIL_PRESS}");
