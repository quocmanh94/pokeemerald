...
const u8 gText_PageNav[] = _("{L_BUTTON}{R_BUTTON} CHANGE PAGE");
...
const u8 gText_TypeEffective[] = _("SHOW EFFECTIVE");
...
const u8 gText_TypeEffectiveOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_TypeEffectiveOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_SelfTradeOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_SelfTradeOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
