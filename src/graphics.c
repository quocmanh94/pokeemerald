...
// Pokedex HGSS
const u16 gPokedexPlus_Default_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_default.gbapal");
const u16 gPokedexPlus_National_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_national.gbapal");
const u16 gPokedexPlus_MenuSearch_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_menu.gbapal");
const u16 gPokedexPlus_SearchResults_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_results.gbapal");
const u16 gPokedexPlus_Default_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_default_dark.gbapal");
const u16 gPokedexPlus_National_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_national_dark.gbapal");
const u16 gPokedexPlus_MenuSearch_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_menu_dark.gbapal");
const u16 gPokedexPlus_SearchResults_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_results_dark.gbapal");
const u32 gPokedexPlus_MenuList_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_list.4bpp.lz");
const u32 gPokedexPlus_MenuList_DECA_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_list_DECA.4bpp.lz");
const u32 gPokedexPlus_Interface_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_interface.4bpp.lz");
const u32 gPokedexPlus_Interface_DECA_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_interface_DECA.4bpp.lz");
const u32 gPokedexPlus_Menu_1_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu1.4bpp.lz");
const u32 gPokedexPlus_Menu_2_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu2.4bpp.lz");
const u32 gPokedexPlus_Menu_3_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu3.4bpp.lz");
const u32 gPokedexPlus_MenuSearch_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_search.4bpp.lz");
const u32 gPokedexPlus_MenuSearch_DECA_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_search_DECA.4bpp.lz");
const u32 gPokedexPlus_StartMenuMain_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_start_menu.bin.lz");
const u32 gPokedexPlus_StartMenuSearchResults_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_start_menu_search_results.bin.lz");
const u32 gPokedexPlus_ScreenSelectBarSubmenu_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/selectbar.bin.lz");
const u32 gPokedexPlus_ScreenSelectBarSubmenu_Tilemap_Clear[] = INCBIN_U32("graphics/pokedex/plus/selectbar_clear.bin.lz");
const u32 gPokedexPlus_ScreenList_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_list_screen.bin.lz");
const u32 gPokedexPlus_ScreenListUnderlay_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_list_screen_underlay.bin.lz");
const u32 gPokedexPlus_ScreenInfo_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_info_screen.bin.lz");
const u32 gPokedexPlus_ScreenStats_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_stats_screen.bin.lz");
const u32 gPokedexPlus_ScreenEvolution_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_evo_screen.bin.lz");
const u32 gPokedexPlus_ScreenEvolution_Tilemap_PE[] = INCBIN_U32("graphics/pokedex/plus/tilemap_evo_screen_PE.bin.lz");
const u32 gPokedexPlus_ScreenForms_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_forms_screen.bin.lz");
const u32 gPokedexPlus_ScreenCry_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_cry_screen.bin.lz");
const u32 gPokedexPlus_ScreenSize_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_size_screen.bin.lz");
const u32 gPokedexPlus_ScreenSearchHoenn_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_search_screen_hoenn.bin.lz");
const u32 gPokedexPlus_ScreenSearchNational_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_search_screen_national.bin.lz");
