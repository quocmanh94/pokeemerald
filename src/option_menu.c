...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsTypeEffect = gTasks[taskId].tTypeEffect == 1 ? FlagSet(FLAG_TYPE_EFFECTIVENESS_BATTLE_SHOW) : FlagClear(FLAG_TYPE_EFFECTIVENESS_BATTLE_SHOW);
...
static void TypeEffect_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TypeEffectOff, GetStringRightAlignXOffset(FONT_SHORT, gText_TypeEffectOff, 198), YPOS_TYPEEFFECT, styles[1]);
}
