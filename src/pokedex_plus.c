...
static const u8 sText_Stats_No_EggCycles[] = _("EGG CIRCLES: ");
static const u8 sText_Stats_EggCycles[] = _("EGG CIRCLES: {EMOJI_DIZZYEGG} ");
...
static const u8 sText_Stats_Friendship_BigAnger[] = _("FRIENDSHIP:  {EMOJI_BIGANGER}");
static const u8 sText_Stats_Friendship_Neutral[] = _("FRIENDSHIP:  {EMOJI_NEUTRAL}");
static const u8 sText_Stats_Friendship_Happy[] = _("FRIENDSHIP:  {EMOJI_HAPPY}");
static const u8 sText_Stats_Friendship_BigSmile[] = _("FRIENDSHIP:  {EMOJI_BIGSMILE}");
...
static const u16 sPokedexPlus_National_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_national.gbapal");
static const u16 sPokedexPlus_MenuSearch_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_menu.gbapal");
static const u16 sPokedexPlus_SearchResults_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_results.gbapal");
static const u16 sPokedexPlus_Default_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_default_dark.gbapal");
static const u16 sPokedexPlus_National_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_national_dark.gbapal");
static const u16 sPokedexPlus_MenuSearch_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_menu_dark.gbapal");
static const u16 sPokedexPlus_SearchResults_dark_Pal[] = INCBIN_U16("graphics/pokedex/plus/palette_search_results_dark.gbapal");
static const u32 sPokedexPlus_MenuList_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_list.4bpp.lz");
static const u32 sPokedexPlus_Interface_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_interface.4bpp.lz");
static const u32 sPokedexPlus_Menu_1_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu1.4bpp.lz");
static const u32 sPokedexPlus_Menu_2_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu2.4bpp.lz");
static const u32 sPokedexPlus_Menu_3_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu3.4bpp.lz");
static const u32 sPokedexPlus_MenuSearch_Gfx[] = INCBIN_U32("graphics/pokedex/plus/tileset_menu_search.4bpp.lz");
static const u32 sPokedexPlus_StartMenuMain_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_start_menu.bin.lz");
static const u32 sPokedexPlus_StartMenuSearchResults_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_start_menu_search_results.bin.lz");
static const u32 sPokedexPlus_ScreenSelectBarSubmenu_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/select_bar.bin.lz");
static const u32 sPokedexPlus_ScreenSelectBarSubmenu_Tilemap_Clear[] = INCBIN_U32("graphics/pokedex/plus/select_bar_clear.bin.lz");
static const u32 sPokedexPlus_ScreenList_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_list_screen.bin.lz");
static const u32 sPokedexPlus_ScreenListUnderlay_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_list_screen_underlay.bin.lz");
static const u32 sPokedexPlus_ScreenInfo_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_info_screen.bin.lz");
static const u32 sPokedexPlus_ScreenStats_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_stats_screen.bin.lz");
static const u32 sPokedexPlus_ScreenEvolution_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_evo_screen.bin.lz");
static const u32 sPokedexPlus_ScreenCry_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_cry_screen.bin.lz");
static const u32 sPokedexPlus_ScreenSize_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_size_screen.bin.lz");
static const u32 sPokedexPlus_ScreenSearchHoenn_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_search_screen_hoenn.bin.lz");
static const u32 sPokedexPlus_ScreenSearchNational_Tilemap[] = INCBIN_U32("graphics/pokedex/plus/tilemap_search_screen_national.bin.lz");
...
struct PokedexView
{
    ...
    struct PokedexListItem evoListItem;
    u8 filler[4];
    u8 currentPage;
...
static void SetInfoScreenTarget(u16 dexNum);
...
static u8 ShowSplitIcon(u32 split); // Physical/Special Split
static void DestroySplitIcon(void); // Physical/Special Split

static u16 NationalPokedexNumToSpeciesPlus(u16 nationalNum);
...
static const u8 sStatBarsGfx[] = INCBIN_U8("graphics/pokedex/plus/stat_bars.4bpp");
...
{
    {sPokedexPlus_Interface_Gfx, 0x2000, TAG_DEX_INTERFACE},
    {0}
};

static const struct SpritePalette sInterfaceSpritePalette[] =
{
    {sPokedexPlus_Default_Pal, TAG_DEX_INTERFACE},
    {sPokedexPlus_Default_dark_Pal, TAG_DEX_INTERFACE},
    {0}
};
...
static void ResetPokedexView(struct PokedexView *pokedexView)
{
    ...
    pokedexView->isShowingShiny = FALSE;
...
static void LoadPokedexBgPalette(bool8 isSearchResults)
{
    if (!HGSS_DARK_MODE)
    {
        if (isSearchResults == TRUE)
            ...
            LoadPalette(sPokedexPlus_Default_Pal + 1, 1, PLTT_SIZEOF(95));
        else
            LoadPalette(sPokedexPlus_National_Pal + 1, 1, PLTT_SIZEOF(95));
        LoadPalette(GetOverworldTextboxPalettePtr(), 0xF0, 32);
    }
    else
    {
        if (isSearchResults == TRUE)
            LoadPalette(sPokedexPlus_SearchResults_dark_Pal + 1, 1, PLTT_SIZEOF(95));
        else if (!IsNationalPokedexEnabled())
            LoadPalette(sPokedexPlus_Default_dark_Pal + 1, 1, PLTT_SIZEOF(95));
        else
            LoadPalette(sPokedexPlus_National_dark_Pal + 1, 1, PLTT_SIZEOF(95));
        LoadPalette(GetOverworldTextboxPalettePtr(), 0xF0, 32);
    }
}
...
static bool8 LoadPokedexListPage(u8 page)
{
    ...
    default:
        ...
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_MenuList_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(1, sPokedexPlus_ScreenList_Tilemap, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenListUnderlay_Tilemap, 0, 0);
        if (page == PAGE_MAIN)
            CopyToBgTilemapBuffer(0, sPokedexPlus_StartMenuMain_Tilemap, 0, 0x280);
        else
            CopyToBgTilemapBuffer(0, sPokedexPlus_StartMenuSearchResults_Tilemap, 0, 0x280);
        ResetPaletteFade();
        if (page == PAGE_MAIN)
            sPokedexView->isSearchResults = FALSE;
        else
...
static void PrintMonDexNumAndName_2(u8 windowId, u8 fontId, const u8 *str, u8 left, u8 top)
{
    u8 color[3];
...
static void SetInfoScreenTarget(u16 dexNum)
{
    ...
    for (i = 0; i < sPokedexView->pokemonListCount; i++)
    {
        ...
        {
            if (i > sPokedexView->selectedPokemon)
                sPokedexView->pokeBallRotation += 16 * (i - sPokedexView->selectedPokemon);
            else
                sPokedexView->pokeBallRotation -= 16 * (sPokedexView->selectedPokemon - i);
            sPokedexView->selectedPokemon = i;
            sPokedexListItem = &sPokedexView->pokedexList[i];
            return;
        }
    }

    sPokedexView->evoListItem.dexNum = dexNum;
    sPokedexView->evoListItem.seen = GetSetPokedexFlag(dexNum, FLAG_GET_SEEN);
    sPokedexView->evoListItem.owned = GetSetPokedexFlag(dexNum, FLAG_GET_CAUGHT);
    sPokedexListItem = &sPokedexView->evoListItem;
}
...
static void Task_LoadInfoScreen(u8 taskId)
{
    ...
    default:
        if (!gPaletteFade.active)
        {
            ...
            sPokedexView->isShowingShiny = FALSE;
...
static void Task_HandleInfoScreenInput(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        if (GetShinySeenFlag(sPokedexListItem->dexNum))
        {
            u16 species = NationalPokedexNumToSpeciesPlus(sPokedexListItem->dexNum);
            ...
            if (sPokedexView->isShowingShiny)
                palette = gMonShinyPaletteTable[species].data;
            else
                palette = gMonPaletteTable[species].data;

            LoadCompressedPalette(palette, OBJ_PLTT_ID(paletteNum), PLTT_SIZE_4BPP);
...
static void Task_LoadAreaScreen(u8 taskId)
{
    ...
    case 1:
        ...
        break;
    case 2:
        ShowPokedexAreaScreen(NationalPokedexNumToSpeciesPlus(sPokedexListItem->dexNum), &sPokedexView->screenSwitchState);
        SetVBlankCallback(gPokedexVBlankCB);
        sPokedexView->screenSwitchState = 0;
        gMain.state = 0;
...
{
    CopyToBgTilemapBuffer(1, sPokedexPlus_ScreenSelectBarSubmenu_Tilemap_Clear, 0, 0);
    CopyBgTilemapBufferToVram(1);
}
...
void Task_DisplayCaughtMonDexPagePlus(u8 taskId)
{
    u8 spriteId;
    u16 dexNum = gTasks[taskId].tDexNum;
    u16 species = NationalPokedexNumToSpeciesPlus(dexNum);
    ...
    case 4:
    {
        ...
        spriteId = CreateMonPicSprite_HandleDeoxys(species, otId, personality, TRUE, MON_PAGE_X, MON_PAGE_Y, 0, TAG_NONE);
...
static void PrintShinyToggleLabel(bool8 isShowingShiny)
{
    u16 *tilemapBuffer = (u16 *)GetBgTilemapBuffer(3);
    u8 startRow = 9;
    u8 startCol = 14;

    tilemapBuffer[startRow * 32 + startCol] = 208;
    tilemapBuffer[startRow * 32 + startCol + 1] = 209;
    tilemapBuffer[startRow * 32 + startCol + 2] = 210;
    tilemapBuffer[startRow * 32 + startCol + 3] = 211;
    tilemapBuffer[(startRow + 1) * 32 + startCol] = 212;
    tilemapBuffer[(startRow + 1) * 32 + startCol + 1] = 213;
    tilemapBuffer[(startRow + 1) * 32 + startCol + 2] = isShowingShiny ? 220 : 214;
    tilemapBuffer[(startRow + 1) * 32 + startCol + 3] = 215;
    tilemapBuffer[(startRow + 2) * 32 + startCol] = 216;
    tilemapBuffer[(startRow + 2) * 32 + startCol + 1] = 217;
    tilemapBuffer[(startRow + 2) * 32 + startCol + 2] = 218;
    tilemapBuffer[(startRow + 2) * 32 + startCol + 3] = 219;
...
static void PrintCurrentSpeciesTypeInfo(u8 newEntry, u16 species)
{
    ...
    if (!newEntry)
        species = NationalPokedexNumToSpeciesPlus(sPokedexListItem->dexNum);
...
static void PrintMonInfo(u32 num, u32 value, u32 owned, u32 newEntry)
{
    ...
    species = NationalPokedexNumToSpeciesPlus(num);
    if (species)
...
static u8 PrintCryScreenSpeciesName(u8 windowId, u16 num, u8 left, u8 top)
{
    ...
    for (i = 0; i < ARRAY_COUNT(str); i++)
        str[i] = EOS;
    num = NationalPokedexNumToSpeciesPlus(num);
    switch (num)
    {
    default:
...
static u32 GetPokedexPlusMonPersonality(u16 species)
{
...
static void LoadTilesetTilemapHGSS(u8 page)
{
    ...
    {
    case INFO_SCREEN:
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenInfo_Tilemap, 0, 0);
        break;
    case STATS_SCREEN:
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenStats_Tilemap, 0, 0);
        break;
    case EVO_SCREEN:
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_Menu_2_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenEvolution_Tilemap, 0, 0);
        break;
    case CRY_SCREEN:
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenCry_Tilemap, 0, 0);
        break;
    case SIZE_SCREEN:
        DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, sPokedexPlus_ScreenSize_Tilemap, 0, 0);
        break;
    }
}
...
static void SaveMonDataInStruct(void)
{
    ...
    u8 EVs[NUM_STATS] =
    {
        gSpeciesInfo[species].evYield_HP,
        gSpeciesInfo[species].evYield_Speed,
        gSpeciesInfo[species].evYield_Attack,
        gSpeciesInfo[species].evYield_SpAttack,
        gSpeciesInfo[species].evYield_Defense,
        gSpeciesInfo[species].evYield_SpDefense
    };
    u8 differentEVs = 0;
    u8 i;
...
static void Task_LoadStatsScreen(u8 taskId)
{
    ...
    case 5:
        if (gTasks[taskId].data[1] == 0)
        {
            ...
            gTasks[taskId].data[4] = CreateMonIcon(species, SpriteCB_MonIcon, 18, 31, 4, GetPokedexPlusMonPersonality(species), TRUE); // Create pokemon sprite
...
static void PrintStatsScreen_Moves_Bottom(u8 taskId)
{
    ...
    if (gTasks[taskId].data[5] == 0)
    {
        ...
        // Physical/Special Split
        DestroySplitIcon();
        ShowSplitIcon(IS_MOVE_STATUS(move) ? MOVE_CATEGORY_STATUS : IS_MOVE_PHYSICAL(move) ? MOVE_CATEGORY_PHYSICAL : MOVE_CATEGORY_SPECIAL);
        // Accuracy
...
static void PrintStatsScreen_Left(u8 taskId)
{
    ...
    else
    {
        ...
        {
        case 35:
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_Friendship_BigAnger, base_x, base_y + base_y_offset * base_i);
            ...
            break;
        case 70:
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_Friendship_Neutral, base_x, base_y + base_y_offset * base_i);
            ConvertIntToDecimalStringN(strEV, sPokedexView->sPokemonStats.friendship, STR_CONV_MODE_RIGHT_ALIGN, 3);
            //StringCopy(strEV, sText_Stats_Friendship_Neutral);
            break;
        case 90:
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_Friendship_Happy, base_x, base_y + base_y_offset * base_i);
            ConvertIntToDecimalStringN(strEV, sPokedexView->sPokemonStats.friendship, STR_CONV_MODE_RIGHT_ALIGN, 3);
        ...
        case 100:
            ...
            break;
        case 140:
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_Friendship_BigSmile, base_x, base_y + base_y_offset * base_i);
            ConvertIntToDecimalStringN(strEV, sPokedexView->sPokemonStats.friendship, STR_CONV_MODE_RIGHT_ALIGN, 3);
        ...
        {
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, sText_Stats_No_EggCycles, base_x, base_y + base_y_offset * base_i);
        ...
        else
        {
            ...
            //     align_x = 67;
            // }
            ConvertIntToDecimalStringN(gStringVar1, sPokedexView->sPokemonStats.eggCycles, STR_CONV_MODE_RIGHT_ALIGN, 3);
            StringCopy(strEV, gStringVar1);
            PrintStatsScreenTextSmall(WIN_STATS_LEFT, strEV, align_x, base_y + base_y_offset * base_i);
        }
        base_i++;
...
static void EvoFormsPage_PrintNavigationButtons(void)
{
    ...
    AddTextPrinterParameterized3(WIN_NAVIGATION_BUTTONS, 0, x + 9, y, sStatsPageNavigationTextColor, 0, sText_EVO_Buttons);
...
static void Task_LoadEvolutionScreen(u8 taskId)
{
    ...
    case 3:
        if (gTasks[taskId].data[1] == 0)
        {
            ...
            gTasks[taskId].data[4] = CreateMonIcon(species, SpriteCB_MonIcon, 18 + 32 * sPokedexView->numPreEvolutions, 31, 4, GetPokedexPlusMonPersonality(species), TRUE); // Create pokemon sprite
    ...
    case 4:
        ...
        PrintEvolutionTargetSpeciesAndMethod(taskId, NationalPokedexNumToSpeciesPlus(sPokedexListItem->dexNum), 0, sPokedexView->numPreEvolutions);
        ...
        if (sPokedexView->sEvoScreenData.numAllEvolutions != 0 && sPokedexView->sEvoScreenData.numSeen != 0)
        {
            ...
            sPokedexView->sEvoScreenData.arrowSpriteId = CreateSprite(&sSpriteTemplate_Arrow, 7, 58 + 9 * pos, 0);
...
static void Task_HandleEvolutionScreenInput(u8 taskId)
{
    if (sPokedexView->sEvoScreenData.numAllEvolutions != 0 && sPokedexView->sEvoScreenData.numSeen != 0)
    {
        ...
        if (sPokedexView->sEvoScreenData.numSeen > 1 && JOY_NEW(DPAD_UP))
        {
            do
            {
                if (pos == 0)
        ...
        else if (sPokedexView->sEvoScreenData.numSeen > 1 && JOY_NEW(DPAD_DOWN))
        {
            do
            {
                pos++;
...
static void HandleTargetSpeciesPrint(u8 taskId, u16 targetSpecies, u16 previousTargetSpecies, u8 base_x, u8 base_y, u8 base_y_offset, u8 base_i, bool8 isEevee)
{
    ...
    StringExpandPlaceholders(gStringVar3, sText_EVO_Name);
    ...
    {
        gTasks[taskId].data[4 + base_i] = CreateMonIcon(targetSpecies, SpriteCB_MonIcon, 50 + 32 * base_i, 31, 4, GetPokedexPlusMonPersonality(targetSpecies), TRUE); // Create pokemon sprite
...
static void HandlePreEvolutionSpeciesPrint(u8 taskId, u16 preSpecies, u16 species, u8 base_x, u8 base_y, u8 base_y_offset, u8 base_i)
{
    ...
    if (base_i < 3)
    {
        gTasks[taskId].data[4 + base_i] = CreateMonIcon(preSpecies, SpriteCB_MonIcon, 18 + 32 * base_i, 31, 4, GetPokedexPlusMonPersonality(preSpecies), TRUE); // Create pokemon sprite
        gSprites[gTasks[taskId].data[4 + base_i]].oam.priority = 0;
    }
}
...
static u8 PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u8 depth_i)
{
    ...
    if (times == 0 && depth == 0)
    {
        ...
        PrintInfoScreenTextSmall(gStringVar4, base_x - 14, base_y + base_y_offset * depth_i);
    }
...
static void Task_HandleCryScreenInput(u8 taskId)
{
    ...
    {
        LoadPlayArrowPalette(TRUE);
        CryScreenPlayButton(NationalPokedexNumToSpeciesPlus(sPokedexListItem->dexNum));
        return;
    }
...
static void TryLoadDarkModeArrowPalette(void)
{
    if (HGSS_DARK_MODE)
    {
        ...
        LoadPalette(colors, OBJ_PLTT_ID(paletteNum) + 1, PLTT_SIZEOF(2));
    }
}
...
static void Task_LoadSearchMenu(u8 taskId)
{
    ...
    case 0:
        if (!gPaletteFade.active)
        {
            ...
            DeactivateAllTextPrinters();
            PutWindowTilemap(0);
            DecompressAndLoadBgGfxUsingHeap(3, sPokedexPlus_MenuSearch_Gfx, 0x2000, 0, 0);
            if (!IsNationalPokedexEnabled())
