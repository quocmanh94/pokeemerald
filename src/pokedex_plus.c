...
{
    {gPokedexPlus_Interface_Gfx, 0x2000, TAG_DEX_INTERFACE},
    {gPokedexPlus_Interface_DECA_Gfx, 0x2000, TAG_DEX_INTERFACE},
    {0}
};

static const struct SpritePalette sInterfaceSpritePalette[] =
{
    {gPokedexPlus_Default_Pal, TAG_DEX_INTERFACE},
    {0}
};
...
static void LoadPokedexBgPalette(bool8 isSearchResults)
{
    if (!HGSS_DARK_MODE)
    {
        if (isSearchResults == TRUE)
            LoadPalette(gPokedexPlus_SearchResults_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        else if (!IsNationalPokedexEnabled())
            LoadPalette(gPokedexPlus_Default_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        else
            LoadPalette(gPokedexPlus_National_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        LoadPalette(GetOverworldTextboxPalettePtr(), 0xF0, 32);
    }
    else
    {
        if (isSearchResults == TRUE)
            LoadPalette(gPokedexPlus_SearchResults_dark_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        else if (!IsNationalPokedexEnabled())
            LoadPalette(gPokedexPlus_Default_dark_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        else
            LoadPalette(gPokedexPlus_National_dark_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(6 * 16 - 1));
        LoadPalette(GetOverworldTextboxPalettePtr(), 0xF0, 32);
    }
...
static bool8 LoadPokedexListPage(u8 page)
{
    ...
    default:
        ...
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_MenuList_Gfx, 0x2000, 0, 0);
        else
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_MenuList_DECA_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(1, gPokedexPlus_ScreenList_Tilemap, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenListUnderlay_Tilemap, 0, 0);
        if (page == PAGE_MAIN)
            CopyToBgTilemapBuffer(0, gPokedexPlus_StartMenuMain_Tilemap, 0, 0x280);
        else
            CopyToBgTilemapBuffer(0, gPokedexPlus_StartMenuSearchResults_Tilemap, 0, 0x280);
        ResetPaletteFade();
        if (page == PAGE_MAIN)
            sPokedexView->isSearchResults = FALSE;
        else
...
{
    CopyToBgTilemapBuffer(1, gPokedexPlus_ScreenSelectBarSubmenu_Tilemap_Clear, 0, 0);
    CopyBgTilemapBufferToVram(1);
}

static void LoadScreenSelectBarSubmenu(u16 unused)
{
    CopyToBgTilemapBuffer(1, gPokedexPlus_ScreenSelectBarSubmenu_Tilemap, 0, 0);
    CopyBgTilemapBufferToVram(1);
}
...
static void Task_HandleCaughtMonPageInput(u8 taskId)
{
    ...
    {
        if (!HGSS_DARK_MODE)
            LoadPalette(gPokedexPlus_Default_Pal + 1, BG_PLTT_ID(3) + 1, PLTT_SIZEOF(7));
        else
            LoadPalette(gPokedexPlus_Default_dark_Pal + 1, BG_PLTT_ID(3) + 1, PLTT_SIZEOF(7));
    }
    else
    {
        if (!HGSS_DARK_MODE)
...
static void LoadTilesetTilemapHGSS(u8 page)
{
    ...
    case INFO_SCREEN:
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
        else
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenInfo_Tilemap, 0, 0);
        break;
    case STATS_SCREEN:
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
            ...
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_1_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenStats_Tilemap, 0, 0);
        break;
    case EVO_SCREEN:
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_2_Gfx, 0x2000, 0, 0);
        else
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_2_Gfx, 0x2000, 0, 0);
        #ifndef POKEMON_EXPANSION
            CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenEvolution_Tilemap, 0, 0);
        #endif
        #ifdef POKEMON_EXPANSION
    ...
    case FORMS_SCREEN: //Pokemonexpansion only (rhh)
        if (!HGSS_DECAPPED)
            ...
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_2_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenForms_Tilemap, 0, 0);
        break;
    case CRY_SCREEN:
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
        else
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenCry_Tilemap, 0, 0);
        break;
    case SIZE_SCREEN:
        if (!HGSS_DECAPPED)
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
            ...
            DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_Menu_3_Gfx, 0x2000, 0, 0);
        CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenSize_Tilemap, 0, 0);
        break;
    }
}
...
static void Task_LoadSearchMenu(u8 taskId)
{
    ...
    case 0:
        if (!gPaletteFade.active)
        {
            ...
            PutWindowTilemap(0);
            if (!HGSS_DECAPPED)
                DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_MenuSearch_Gfx, 0x2000, 0, 0);
            else
                DecompressAndLoadBgGfxUsingHeap(3, gPokedexPlus_MenuSearch_DECA_Gfx, 0x2000, 0, 0);
            if (!IsNationalPokedexEnabled())
                CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenSearchHoenn_Tilemap, 0, 0);
            else
                CopyToBgTilemapBuffer(3, gPokedexPlus_ScreenSearchNational_Tilemap, 0, 0);
            if (!HGSS_DARK_MODE)
                LoadPalette(gPokedexPlus_MenuSearch_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(4 * 16 - 1));
            else
                LoadPalette(gPokedexPlus_MenuSearch_dark_Pal + 1, BG_PLTT_ID(0) + 1, PLTT_SIZEOF(4 * 16 - 1));
            gMain.state = 1;
        }
        break;
    case 1:
