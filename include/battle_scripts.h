...
extern const u8 BattleScript_AbilityActivates[];
extern const u8 BattleScript_AbilityActivatesEnd3[];
extern const u8 BattleScript_AbilityRestoresHpEnd3[];
extern const u8 BattleScript_AbilityDamages[];
extern const u8 BattleScript_AbilityDamagesEnd3[];
extern const u8 BattleScript_AnticipationActivates[];
extern const u8 BattleScript_FriskActivates[];
extern const u8 BattleScript_FriskActivatesTwoItems[];
