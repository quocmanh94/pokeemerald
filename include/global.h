...
struct SaveBlock2
{
    ...
    /*0x90*/ u16 optionsPokemonFollowersOff:1;
             u16 optionsPokedexTheme:1;
             u16 optionsBattleBarSpeed:1;
             u16 optionsTypeEffectivenessOff:1;
             u16 optionsCatchAndSwapOff:1;
             u16 optionsAbilityPopupsOff:1;
             u16 optionsPushBToRunOff:1;
...
struct SaveBlock1
{
    ...
    /*0x3598*/ u8 shinySeen[NUM_DEX_FLAG_BYTES];
    /*0x35CC*/ u8 unused_35CC[0x14A];
    /*0x3716*/ u16 registeredLongItem; // registered for use by holding SELECT button
