...
#define OPTIONS_FEATURE_ON  0
#define OPTIONS_FEATURE_OFF 1

#define OPTIONS_POKEDEX_THEME_LIGHT 0
#define OPTIONS_POKEDEX_THEME_DARK  1

#define OPTIONS_BATTLE_BAR_FAST   0
#define OPTIONS_BATTLE_BAR_NORMAL 1

#define OPTIONS_MATCH_CALLS_REMATCH 0
#define OPTIONS_MATCH_CALLS_ALL     1

#define OPTIONS_LANGUAGE_VIETNAMESE 0
#define OPTIONS_LANGUAGE_ENGLISH    1
