...
#define FLDEFFOBJ_ORAS_DOWSE_BRENDAN    40
#define FLDEFFOBJ_ORAS_DOWSE_MAY        41
...
#define FLDEFF_TILE_TAG_POKECENTER_LIGHT    0x1404
#define FLDEFF_TILE_TAG_MART_LIGHT          0x1405
