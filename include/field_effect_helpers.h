...
void SynchronizeSurfAnim(struct ObjectEvent *objectEvent, struct Sprite *sprite);
void SynchronizeSurfPosition(struct ObjectEvent *objectEvent, struct Sprite *sprite);
void UpdateSurfBobbingEffect(struct ObjectEvent *objectEvent, struct Sprite *playerSprite, struct Sprite *surfSprite);
