...
// pokedex HGSS
extern const u16 gPokedexPlus_Default_Pal[];
extern const u16 gPokedexPlus_National_Pal[];
extern const u16 gPokedexPlus_MenuSearch_Pal[];
extern const u16 gPokedexPlus_SearchResults_Pal[];
extern const u16 gPokedexPlus_Default_dark_Pal[];
extern const u16 gPokedexPlus_National_dark_Pal[];
extern const u16 gPokedexPlus_MenuSearch_dark_Pal[];
extern const u16 gPokedexPlus_SearchResults_dark_Pal[];
extern const u32 gPokedexPlus_MenuList_Gfx[];
extern const u32 gPokedexPlus_MenuList_DECA_Gfx[];
extern const u32 gPokedexPlus_Interface_Gfx[];
extern const u32 gPokedexPlus_Interface_DECA_Gfx[];
extern const u32 gPokedexPlus_Menu_1_Gfx[];
extern const u32 gPokedexPlus_Menu_2_Gfx[];
extern const u32 gPokedexPlus_Menu_3_Gfx[];
extern const u32 gPokedexPlus_MenuSearch_Gfx[];
extern const u32 gPokedexPlus_MenuSearch_DECA_Gfx[];
extern const u32 gPokedexPlus_StartMenuMain_Tilemap[];
extern const u32 gPokedexPlus_StartMenuSearchResults_Tilemap[];
extern const u32 gPokedexPlus_ScreenSelectBarSubmenu_Tilemap[];
extern const u32 gPokedexPlus_ScreenSelectBarSubmenu_Tilemap_Clear[];
extern const u32 gPokedexPlus_ScreenList_Tilemap[];
extern const u32 gPokedexPlus_ScreenListUnderlay_Tilemap[];
extern const u32 gPokedexPlus_ScreenInfo_Tilemap[];
extern const u32 gPokedexPlus_ScreenStats_Tilemap[];
extern const u32 gPokedexPlus_ScreenEvolution_Tilemap[];
extern const u32 gPokedexPlus_ScreenEvolution_Tilemap_PE[];
extern const u32 gPokedexPlus_ScreenForms_Tilemap[];
extern const u32 gPokedexPlus_ScreenCry_Tilemap[];
extern const u32 gPokedexPlus_ScreenSize_Tilemap[];
extern const u32 gPokedexPlus_ScreenSearchHoenn_Tilemap[];
extern const u32 gPokedexPlus_ScreenSearchNational_Tilemap[];
